...
const LiquidGlass: React.FC = () => {
  useEffect(() => {
    // Simplified version of the liquid glass effect for React
        ...
        class Shader {
          ...
          createElement() {
            ...
            this.container.style.cssText = \`
              ...
              cursor: grab;
              backdrop-filter: url(#\${this.id}_filter) blur(0.5px) contrast(1.1) brightness(1.02) saturate(1.05);
              z-index: 1000;
              pointer-events: auto;
              opacity: 0.8;
            \`;
          ...
          updateShader() {
            ...
            maxScale *= 0.3; // Reduced intensity for subtlety
            let index = 0;
